...
#include "Walnut/Embed/WindowImages.embed"
	...
	void Application::Init()
	{
		...
		0x0400, 0x052F, // Cyrillic (includes Russian, Ukrainian, etc.)
		...
		ImFont* robotoFont = io.Fonts->AddFontFromMemoryTTF((void*)g_RobotoRegular, sizeof(g_RobotoRegular), 20.0f, &fontConfig, glyphRanges);
	...
	void Application::Run()
	{
		...
		while (!glfwWindowShouldClose(m_WindowHandle) && m_Running)
		{
			...
			//Skip OnUpdate if app is minimised
			...
			TextureGarbageCollector::Collect(); //Garbage Collection
